...
export default function InputSearch() {
  return (
    <div className="flex relative">
      <input
        className={`${font.className} w-[150] bg-[#393939] border-solid border-l border-[rgba(255,255,255,0.3)] font-light text-white placeholder:text-[rgba(255,255,255,0.3)] placeholder:text-xs px-[16]`}
        type="text"
