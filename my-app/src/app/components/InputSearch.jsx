...
export default function InputSearch() {
  return (
    <div className="flex relative group">
      <input
        className={`${font.className} w-[150] bg-[#393939] border-solid border-l border-[rgba(255,255,255,0.3)] font-light text-white placeholder:text-[rgba(255,255,255,0.3)] placeholder:text-xs px-[16] outline-none focus:placeholder:text-white`}
        type="text"
        placeholder="Search for"
      />
      <svg
        className="absolute top-[50%] right-[16] -translate-y-1/2 pointer-events-none"
        width="12"
        height="12"
        viewBox="0 0 12 12"
        fill="none"
